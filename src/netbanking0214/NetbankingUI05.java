...
public class NetbankingUI05 {
	...
	public NetbankingUI05(DTO_netbankingUI04 _paramDTO) {
		...
		initialize();
		tfSei.setText(_paramDTO.getStr_sei());
		tfMai.setText(_paramDTO.getStr_mei());
		tfYear.setText(_paramDTO.getStr_birthday().substring(0, 4));
		tfMonth.setText(_paramDTO.getStr_birthday().substring(5, 7));
		tfDay.setText(_paramDTO.getStr_birthday().substring(8, _paramDTO.getStr_birthday().length()));
		String miseban = String.valueOf(_paramDTO.getNum_brId());
		miseban = String.format("%3s",miseban).replace(" ", "0");
		tfMiseban.setText(miseban);
		tfSitenmei.setText(_paramDTO.getStr_brName());
		tfKamoku.setText(_paramDTO.getStr_subName());
		pfPassword.setText(_paramDTO.getStr_pwCfm());
