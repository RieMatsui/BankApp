...
public class NetbankingUI04 {
	...
	private JPasswordField pfPwCfm;
	...
	public NetbankingUI04(DTO_tmp_netbanking _paramData) {
		initialize();
		num_userId = _paramData.getNum_userId();
		System.out.println(num_userId);
		pfPassword = new JPasswordField();
		pfPassword.setBounds(212, 361, 201, 33);
		frame.getContentPane().add(pfPassword);

		pfPwCfm = new JPasswordField();
		pfPwCfm.setBounds(212, 448, 201, 33);
		frame.getContentPane().add(pfPwCfm);
	...
	private void initialize() {
		...
		label_1.setBounds(38, 275, 150, 33);
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				str_pwCfm = pfPwCfm.getText();

				DTO_netbankingUI04 vrb_DTOUI4 = new DTO_netbankingUI04(num_userId,
																	   str_password,
																	   str_sei,
																	   str_mei,
																	   str_birthday,
