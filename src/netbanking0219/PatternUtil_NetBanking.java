...
public class PatternUtil_NetBanking {
	...
	public enum PatternEnum {
		...
		//半角カタカナ濁音、半濁音
		HANKAKU_KATAKANA_DAKUON_HANDAKUON("^[ﾞﾟ]"),

		//全角ひらがなカタカナ
		ZENKAKU_KATAKANA("^[ァ-ン]+$"),

		//全角濁音
		ZENKAKU_DAKU_HANDAKUON("^[ガギグゲゴザジズゼゾダヂヅデドバパビピブプベペボポヴ]+$"),
	...
	public static void main(String[] args) {
		...
		final boolean resultX = PatternUtil_NetBanking.findMatches(patternX, "104001");
