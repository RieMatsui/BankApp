...
public class NetbankingUI06 {
	 ...
	 */
	public static void main(final DTO_userTable_netbankingUI05 vrb_t_user) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NetbankingUI06 window = new NetbankingUI06(vrb_t_user);
	 ...
	 */
	public NetbankingUI06(DTO_userTable_netbankingUI05 vrb_t_user) {
		initialize();
		tfAccount.setText(String.valueOf(vrb_t_user.getNum_accountNo()));
	...
	private void initialize() {
		...
		label_3.setBounds(50, 213, 158, 24);
		frame.getContentPane().add(label_3);

		label_4 = new JLabel("口座新規開設は、正常に完了いたしました。");
		label_4.setFont(new Font("MS UI Gothic", Font.PLAIN, 15));
		label_4.setBounds(50, 271, 632, 24);
		...
		JLabel label_6 = new JLabel("「操作メニューへ戻る」ボタンを押してください。");
		label_6.setFont(new Font("Dialog", Font.PLAIN, 15));
		label_6.setBounds(50, 318, 632, 24);
		frame.getContentPane().add(label_6);

		tfAccount = new JTextField();
		tfAccount.setBackground(SystemColor.window);
		tfAccount.setBounds(340, 213, 130, 26);
		frame.getContentPane().add(tfAccount);
		tfAccount.setColumns(10);

		JLabel label_7 = new JLabel("口座番号は");
		label_7.setFont(new Font("Dialog", Font.PLAIN, 15));
		label_7.setBounds(226, 213, 102, 24);
		frame.getContentPane().add(label_7);

		JLabel label_8 = new JLabel("です");
		label_8.setFont(new Font("Dialog", Font.PLAIN, 15));
		label_8.setBounds(495, 213, 102, 24);
